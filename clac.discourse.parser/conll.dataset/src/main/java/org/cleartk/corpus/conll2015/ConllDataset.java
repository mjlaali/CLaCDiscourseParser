...
public class ConllDataset implements DatasetPath{
	public static final String OUTPUT_FILE_NAME_CONVENTION = "%s_%s_%s.txt";
	...
	public String getExplicitRelSystemOutFile(){
		String exportFilePath = String.format("outputs/parser/" + OUTPUT_FILE_NAME_CONVENTION,
	...
	public String getImplicitRelSystemOutFile(){
		String implicitFilePath = String.format("outputs/parser/" + OUTPUT_FILE_NAME_CONVENTION,

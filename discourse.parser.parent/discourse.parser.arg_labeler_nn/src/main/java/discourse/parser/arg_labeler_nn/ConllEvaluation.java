...
//		outputDirectory = new File(options.getOutputDir());
		outputDirectory = new File("outputs/results");
		...
		File packageFile = new File(new File("outputs/resources"), "package");
		AnalysisEngineDescription argumentLabeler = ArgLabelerFeatureExtractor.getClassifierDescription(packageFile);
